...
<script lang="ts">
	...
	onMount(() => {
		...
		L.marker([20.0512347, 83.6255479], { icon: planeIcon }).addTo(map).bindPopup("ECHO").openPopup()

		L.marker([13.174099, 77.741782], { icon: arucoIcon }).addTo(map).bindPopup("HQ").openPopup()
	})
</script>
